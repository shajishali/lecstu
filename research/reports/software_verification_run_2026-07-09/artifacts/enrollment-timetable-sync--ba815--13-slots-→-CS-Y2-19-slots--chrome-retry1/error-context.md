...
- Name: enrollment-timetable-sync.spec.ts >> Enrollment change → timetable auto-update >> timetable updates: CS-Y3-AINT (13 slots) → CS-Y2 (19 slots)
- Location: tests\enrollment-timetable-sync.spec.ts:113:7
