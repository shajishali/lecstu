...
- Name: student-timetable.spec.ts >> Y3 CS-AINT student timetable >> ALL required courses visible — full regression check
- Location: tests\student-timetable.spec.ts:172:7
